  ...
  useScrollProgressEffect(
    (progress) => {
      ...
      if (stemClipRectRef.current) {
        stemClipRectRef.current.setAttribute('y', String(2481 - stemClipHeight))
    ...
    >
      <defs>
        <clipPath id="leaf-four-stem-clip">
          <rect ref={stemClipRectRef} x="0" y="2481" width="941" height="0" />
        </clipPath>
        <clipPath id="leaf-four-fill-reveal">
          <circle ref={fillCircleRef} cx="607" cy="61" r="0" />
        </clipPath>
      </defs>
      <path
